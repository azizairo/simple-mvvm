...
import ur.azizairo.foundation.sideeffects.SideEffectImplementationsHolder
...
class ActivityDelegate(
    ...
    private val activityViewModel by activity.viewModelCreator<ActivityScopeViewModel> {
