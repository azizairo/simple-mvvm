...
class SideEffectMediatorsHolder {
    ...
    /**
     * Create and store [SideEffectMediator] by using specified [SideEffectPlugin].
     */
    ...
    /**
     * Tie [SideEffectImplementation] with the [SideEffectMediator]. So mediator can deliver all
